...
sap.ui.define([
	...
	"use strict";
	var oMockServer,
		_sAppModulePath = "fin.ap.process.payments/",
	...
	return {
		...
		/**
		 * Getter for the the mockserver of the app, should be used in integration tests
		 * 
		 * @return {sap.ui.core.util.MockServer} Returns the mockserver of the app
		 */
